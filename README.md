...
- `docs/production-deployment-guide.md`：生产部署专用指南，覆盖静态前端、生产 Compose、Nginx、备份、升级和回滚。
...
服务器迁移和部署步骤见 `docs/server-deployment-guide.md`。长期生产部署建议参考 `docs/production-deployment-guide.md`。
